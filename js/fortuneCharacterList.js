...
var characterList = [
	...
	}, 
	{
		...
		"voice":"peris",
		"address":"시궁창",
		"intro":"%x을(를) 알고 싶다고? 니가 보기에 내가 그런 거 잘 할 거 처럼 보여?$$그래, 예전에 실버크라운 다녀왔을 때 그 수호자한테 뭔가 들은 게 있다마는…$$알았어, 들려줄테니까 그만 좀 보채라.",
		"casting":"잠깐 기다려봐.",
	...
	}, 
	{
		...
		"voice":"",
		"address":"헨돈마이어",
		"intro":"순순히 다이아몬드를 넘긴다면 유혈사태는 일어나지 않을 겁니다.$$오, 꽤 훌륭한 다이아몬드로군요. 제가 값을 쳐드리겠습니다.$$그래, 제가 좋은 점괘를 알려드리면 되겠군요. %x 어떻습니까?",
		"casting":"조금만 기다리면 됩니다.",
		"result":"이 정도면 아주 공정한 무역이지요. 그렇지 않습니까?",
		"favorImg":"",
		"like":2,
		"dislike":3,
		"gift_like":"오, 꽤 근사한 물건이군요. 다음 거래도 기대하겠습니다.",
		"gift_normal":"나쁘지 않군요. 받아두겠습니다.",
		"gift_dislike":"한번 더 그러면 그대 머리 위에 핵미사일이 떨어질지도 모릅니다. 조심하십시오.",
		"buff_casting":"",
		"buff_result":""
	}, 
	{
