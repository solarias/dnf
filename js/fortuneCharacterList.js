...
var characterList = [
	...
	}, 
	{
		...
		"voice":"",
		"address":"시궁창",
		"intro":"모험가님, 잘 오셨습니다$$마침 제국의 시찰단이 들이닥쳐서 이곳 경비가 삼엄해졌서 지금 밖에 나가시면 위험합니다.$$이래서는 레지스탕스가 활동하기 힘들겠군요. 시찰단이 돌아갈 때까지 그냥 시간을 보내면 조금 무료하겠어요.$$그래서 말인데, 제가 여기 주인에게 들은 점을 하나 알려드리지요.$$세상에 몇 남지 않은 엘프가 알려준 점술이니 꽤 괜찮을 겁니다.",
		"casting":"잠시 점을 쳐보겠습니다.",
	...
	}, 
	{
		...
		"voice":"",
		"address":"세인트혼",
		"intro":"%x을(를) 봐달라고? 요새 젊은이들한테는 점이 유행인가보구만.$$점을 방법은 간단해. 일단 브레스를 거하게 뿜은 다음…..$$알았어, 루드밀라. 농담이야, 농담.$$아, 그건 나중에 안주거리 삼아 얘기해주지. 지금은 자네도 시간이 없어 보이니 약식으로…",
		"casting":"어디보자……",
	...
	}, 
	{
		...
		"voice":"",
		"address":"헨돈마이어",
		"intro":"순순히 다이아몬드를 넘긴다면 유혈사태는 일어나지 않을 겁니다.$$훌륭한 다이아몬드로군요. 값을 쳐드리지요.$$제가 좋은 점괘를 알려드리죠. %x 어떻습니까?",
