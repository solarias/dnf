...
window.onload = function() {
	...
	for (var i=0;i<chaList.length;i++) {
		if (chaList[i][0] != "") {
			imageList.push(images + chaList[i][1] + "");
		}
	}
